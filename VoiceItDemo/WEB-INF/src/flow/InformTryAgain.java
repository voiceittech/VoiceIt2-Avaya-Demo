 ...
 * Last generated by Orchestration Designer at: 2018-NOV-08  05:16:17 PM
 */
public class InformTryAgain extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("MainTryAgain", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("SayGoodbye");
		return submit;
	}
	/**
