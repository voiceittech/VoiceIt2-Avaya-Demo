 ...
 */
public class Authenticate_Passphrase extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Orchestration Designer at: (timestamp generation disabled)
	 */
	public Authenticate_Passphrase() {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("AuthenticateCaller");
		return submit;
	}
	/**
	...
	public com.avaya.sce.runtime.Record getRecord(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		promptNames.add(new com.avaya.sce.runtime.PromptRefInfo("Authentication_Passphrase", ""));

		// build events for the record item: "Authenticate_Passphrase"
		events = new java.util.ArrayList();
		event = new com.avaya.sce.runtime.OnDisconnect("Return", true);
		events.add(event);
		...
		record = new com.avaya.sce.runtime.Record("Authenticate_Passphrase", true, "5s", true, "3s", false, com.avaya.sce.runtime.Record.WAV_TYPE, com.avaya.sce.runtime.Record.RECORDMODE_AUDIO, promptNames, grammarInfo, events);
		return record;
	}
	/**
