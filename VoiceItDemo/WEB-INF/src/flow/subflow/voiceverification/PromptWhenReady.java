 ...
 * Last generated by Orchestration Designer at: 2018-NOV-08  07:17:07 PM
 */
public class PromptWhenReady extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		promptNames.add(new com.avaya.sce.runtime.PromptRefInfo("VerificationPromptWhenReady", ""));
		...
		// build events for the field: "VerificationReadyPrompt"
		...
		int nbest = 1;
		field = new com.avaya.sce.runtime.Field("VerificationReadyPrompt", false, true, grammarInfo, promptNames, events, properties, nbest, false, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("voiceverification-GetRecording");
		return submit;
	}
	/**
