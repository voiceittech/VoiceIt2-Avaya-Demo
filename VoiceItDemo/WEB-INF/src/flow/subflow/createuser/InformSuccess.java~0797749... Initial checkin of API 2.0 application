 ...
 * Last generated by Orchestration Designer at: 2018-NOV-08  04:57:35 PM
 */
public class InformSuccess extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("CreateUserSuccess", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("createuser-GetPhraseToSpeak");
		return submit;
	}
	/**
