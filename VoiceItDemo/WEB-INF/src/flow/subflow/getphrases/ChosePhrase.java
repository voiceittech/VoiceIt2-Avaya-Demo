...
public class ChosePhrase extends com.avaya.sce.runtime.BasicServlet {
	...
	public void servletImplementation(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		mySession.getTraceOutput().writeln(ITraceInfo.TRACE_LEVEL_DEBUG, String.format("Storing [%s] to [%s]", variable.getField(flow.IProjectVariables.ALL_PHRASES_FIELD_TEXT), variableName.toString()));
		mySession.getVariableField(variableName).setValue(variable.getField(flow.IProjectVariables.ALL_PHRASES_FIELD_TEXT));
	}
	/**
