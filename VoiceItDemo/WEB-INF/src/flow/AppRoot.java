...
public class AppRoot extends com.avaya.sce.runtime.Root {
	...
	public java.util.Collection getProperties(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		property = new com.avaya.sce.runtime.Property("fetchaudio", "BackgroundTransitional");
		list.add(property);

		property = new com.avaya.sce.runtime.Property("fetchaudiodelay", "3s");
		list.add(property);

		property = new com.avaya.sce.runtime.Property("fetchaudiominimum", "1s");
		list.add(property);
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.OnDisconnect("EndOfApplication", false);
		list.add(event);
		return(list);
	}
}
