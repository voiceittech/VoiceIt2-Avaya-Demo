 ...
 */
public class getphrases extends com.avaya.sce.runtime.Phraseset { 
	...
	static {
		...
		// phrase: getphrases-0000
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "getphrases-0000", "getphrases-0000.wav", "I\'m sorry. I could not retrieve a list of phrases available."); 
	...
	public com.avaya.sce.runtime.Phrase getPhrase(String phraseName) {
		return(getPhrase(getphrases.PHRASE_MAP, phraseName));
	}
}
